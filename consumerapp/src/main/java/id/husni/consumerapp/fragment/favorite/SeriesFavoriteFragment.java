package id.husni.consumerapp.fragment.favorite;
...
import id.husni.consumerapp.adapter.SeriesFavoriteAdapter;
import id.husni.consumerapp.callback.SeriesCallback;
import id.husni.consumerapp.database.MappingHelper;
import id.husni.consumerapp.model.SeriesFavorite;

import static id.husni.consumerapp.database.DatabaseContract.URI_SERIES;
