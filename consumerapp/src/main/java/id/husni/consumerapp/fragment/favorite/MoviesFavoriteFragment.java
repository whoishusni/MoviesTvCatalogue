...
import id.husni.consumerapp.adapter.MoviesFavoriteAdapter;
import id.husni.consumerapp.callback.MoviesCallback;
import id.husni.consumerapp.database.MappingHelper;
import id.husni.consumerapp.model.MoviesFavorite;

import static id.husni.consumerapp.database.DatabaseContract.URI_MOVIES;
